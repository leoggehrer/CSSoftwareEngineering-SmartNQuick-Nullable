...
3.4 DbSet für das Entity definieren  
3.5 DbSet in GetDbSet() eintragen  

4. Kontroller für das Entity erzeugen  
4.1 Abgeleitet vom GenericPersistenceController  

5. Das Entity auf die Datenbank übertragen  
5.1 Migration starten und sprechenden Namen vergeben (add-migration Name)  
5.2 Migration auf die Datenbank übertragen (update-database)  
